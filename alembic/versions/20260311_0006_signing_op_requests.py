...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "emergency", sa.Boolean(), nullable=False, server_default=sa.text("false")
        ),
        sa.Column(
            "create_replacement",
            sa.Boolean(),
    ...
    op.create_index(
        op.f("ix_signing_key_operation_requests_operation_type"),
        "signing_key_operation_requests",
        ["operation_type"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signing_key_operation_requests_requested_by"),
        "signing_key_operation_requests",
        ["requested_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signing_key_operation_requests_approved_by"),
        "signing_key_operation_requests",
        ["approved_by"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signing_key_operation_requests_status"),
        "signing_key_operation_requests",
        ["status"],
        unique=False,
    )
    op.create_index(
        op.f("ix_signing_key_operation_requests_created_at"),
        "signing_key_operation_requests",
        ["created_at"],
        unique=False,
    )
...
def downgrade() -> None:
    op.drop_index(
        op.f("ix_signing_key_operation_requests_created_at"),
        table_name="signing_key_operation_requests",
    )
    op.drop_index(
        op.f("ix_signing_key_operation_requests_status"),
        table_name="signing_key_operation_requests",
